...
public class MineBackup extends Base
{
   ...
   public static final String logPrefix = "[Minebackup] ";
   ...
   {
      return getServer().getScheduler().runTaskLaterAsynchronously(this, process, 5 * 20L).getTaskId();
   }
   ...
   public void spawnProcess(int delay)
   {
      ...
      else
      {
         ...
         processId = getServer().getScheduler().runTaskTimerAsynchronously(this, process.setQuick(false), delay * 20L, 60 * 20L).getTaskId();
      }
   }
   ...
   public void spawnUpload(int delay)
   {
      ...
      if (delay == 0)
      {
         ...
         uploadId = getServer().getScheduler().runTaskLaterAsynchronously(this, upload.setQuick(true), 5 * 20L).getTaskId();
      }
      else
      {
         ...
         uploadId = getServer().getScheduler().runTaskTimerAsynchronously(this, upload.setQuick(false), delay * 20L, 300 * 20L).getTaskId();
      }
   }
